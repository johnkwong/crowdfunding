...
<div class="container ">
	<div class="row clearfix">
		<h1>請按照我們的順序完成項目發起</h1>
			<ul class="nav nav-pills">
				<li @if($step == 1){!! "class='active'" !!}@endif><a href="/project/create/{{ $project->id }}/1">項目簡介</a></li>
				<li @if($step == 2){!! "class='active'" !!}@endif><a href="/project/create/{{ $project->id }}/2">項目大綱</a></li>
				<li @if($step == 3){!! "class='active'" !!}@endif><a href="/projectreward/create/{{ $project->id }}/3">回饋設置</a></li>
			</ul>
			<hr>
			...
			@include('projects.projectform.step1', ['submitButtonText' => '下一步'])
			...
			@include('projects.projectform.step2', ['submitButtonText' => '下一步'])
		...
		<a class="btn btn-primary pull-right" style="margin-left:10px;" href="/">取消</a>
				<a class="btn btn-primary pull-right" style="margin-left:10px;" href="{{ route('projectstatus.update', $project->id) }}">完成</a>
			@endif
		</div>	
	</div>	
</div>
